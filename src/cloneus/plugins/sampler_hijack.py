# Src: https://github.com/IlyaGusev/quest/blob/main/quest/sampler_hijack.py
...
def get_logits_processor_patch(self, **kwargs):
    ...
    if generation_config.dry_multiplier is not None and generation_config.dry_multiplier > 0.0:
        ...
        tokenizer = kwargs.get('tokenizer') # shared.tokenizer # NOTE: this almost certainly won't work
...
def hijack_samplers():
    # include check to prevent double activation (check not done by text webui)
...
# GenerationConfig.get_generation_mode() and
# from transformers.generation import GenerationMode
# Mirostat, DynamicTemperature, etc..